...
Public Class Salida
    ...
    Private Sub grabbtn_Click(sender As Object, e As EventArgs) Handles grabbtn.Click
        If dtable.Rows.Count > 0 Then
            ...
            Dim auxdcolum1 As New DataColumn("ID_SALIDA", GetType(String))
            Dim auxdcolum2 As New DataColumn("ID_DETALLE_SALIDA", GetType(String))
            ...
            Try
                ...
                Using bulkC As New SqlBulkCopy(con)
                    ...
                    bulkC.DestinationTableName = "DETALLE_SALIDA"
            ...
            contd = idsaltxt.Text + "," + fechtxt.Text
            Dim sqlins As String = "INSERT INTO SALIDA VALUES('" + idsaltxt.Text + "',@fecha,'" + Login.codus + "','" + NSalida.clientetxt.Text + "','" + subttxt.Text + "','" + igvtxt.Text + "','" + totaltxt.Text + "',@QR)"
            Dim cmd As New SqlCommand(sqlins, con)
            cmd.Parameters.Add("@fecha", SqlDbType.DateTime).Value = Now
            cmd.Parameters.Add("@QR", SqlDbType.Image).Value = ImagenAByte(generarqr(contd))
    ...
    Private Sub impbtn_Click(sender As Object, e As EventArgs) Handles impbtn.Click
        pdfSalida(sfd, ImagenAByte(generarqr(contd)))
        dtable.Rows.Clear()
        refrescardetalle()
        actualizarcostos(0)
    End Sub
